...
const W1: WorkoutSession = {
  ...
  exercises: [
    ...
    { id: tid(), exerciseName: "S1: Same Wt More Reps",    muscleGroups: ["Chest"], sets: [mkSet("100", "5")] },
    // Scenario 2: same weight, fewer reps
    { id: tid(), exerciseName: "S2: Same Wt Fewer Reps",   muscleGroups: ["Chest"], sets: [mkSet("100", "5")] },
    // Scenario 3: more weight, same reps
    { id: tid(), exerciseName: "S3: More Wt Same Reps",    muscleGroups: ["Chest"], sets: [mkSet("100", "5")] },
    // Scenario 4: more weight, massive rep drop
    { id: tid(), exerciseName: "S4: Wt Up Reps Drop",      muscleGroups: ["Chest"], sets: [mkSet("100", "10")] },
    // Scenario 5: less weight, many more reps — e1RM should improve
    { id: tid(), exerciseName: "S5: Wt Down E1RM Up",      muscleGroups: ["Chest"], sets: [mkSet("100", "5")] },
    // Scenario 6: stagnation, session 1 of 3
    { id: tid(), exerciseName: "S6: Stagnation",           muscleGroups: ["Chest"], sets: [mkSet("100", "5")] },
  ],
};
...
const W2: WorkoutSession = {
  ...
  exercises: [
    ...
    { id: tid(), exerciseName: "S1: Same Wt More Reps",    muscleGroups: ["Chest"], sets: [mkSet("100", "6")] },
    // Scenario 2: 100×3 — e1RM down, rDiff = -2 → expected: regressing
    { id: tid(), exerciseName: "S2: Same Wt Fewer Reps",   muscleGroups: ["Chest"], sets: [mkSet("100", "3")] },
    // Scenario 3: 102.5×5 — e1RM up → expected: progressing
    { id: tid(), exerciseName: "S3: More Wt Same Reps",    muscleGroups: ["Chest"], sets: [mkSet("102.5", "5")] },
    // Scenario 4: 102.5×1 — e1RM drops sharply (~24%) → expected: regressing
    { id: tid(), exerciseName: "S4: Wt Up Reps Drop",      muscleGroups: ["Chest"], sets: [mkSet("102.5", "1")] },
    // Scenario 5: 97.5×10 — e1RM ~124.5 vs ~116.7 (+6.6%) → expected: progressing, NOT regressing
    { id: tid(), exerciseName: "S5: Wt Down E1RM Up",      muscleGroups: ["Chest"], sets: [mkSet("97.5", "10")] },
...
const W3: WorkoutSession = {
  ...
  exercises: [
    ...
    { id: tid(), exerciseName: "S9: First Session",        muscleGroups: ["Chest"], sets: [mkSet("100", "5")] },
